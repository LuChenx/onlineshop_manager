...
public interface SysManagerSupplierMapper {
     ...
     * @mbg.generated Fri Jan 11 16:03:09 CST 2019
     */
    int updateByExampleSelective(@Param("record") SysManagerSupplier record, @Param("example") SysManagerSupplierExample example);
     ...
     * @mbg.generated Fri Jan 11 16:03:09 CST 2019
     */
    int updateByExample(@Param("record") SysManagerSupplier record, @Param("example") SysManagerSupplierExample example);
